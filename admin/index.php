		...
		<div class="container theme-showcase" role="main">
			<div class="page-header">
				<div class="row">
					...
					<p><a href="cadastrarLivro.php" class="btn btn-primary" role="button">Adcionar um novo livro</a> </p>
					</div>
					<div class="col-sm-6 col-md-6">
					...
					<div class="col-sm-6 col-md-6">
						<div class="thumbnail">
							...
							<div class="caption text-center">
								...
								<p><a href="editar_livro.php?id=<?php echo $rows_livros['id'];?> " class="btn btn-primary" role="button">Editar</a> </p>
								
								<p><a href="deleteLivro.php.?id=<?php echo $rows_livros['id'];?> " class="btn btn-primary" role="button">Excluir</a> </p>
